...
const Sidebar = ({type}) => {
  ...
  if (type == "hosted") {
    return (
      <div className="md:min-h-screen w-full md:w-[30%] md:max-w-[600px] bg-[var(--accent-color)] flex flex-col p-4 md:p-6 lg:p-12">
  ...
  if (type == "direct") {
    return (
      <div className="min-h-screen md:w-[30%] flex-col mt-10 -mr-6 p-12 pr-0 hidden md:flex">
